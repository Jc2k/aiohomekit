...
class TestCharacteristicsTypes(unittest.TestCase):
    def test_getitem_forward(self):
        self.assertEqual(
            CharacteristicsTypes[CharacteristicsTypes.ON],
            "public.hap.characteristic.on",
        )

    def test_getitem_reverse(self):
        self.assertEqual(
            CharacteristicsTypes["public.hap.characteristic.on"],
...
class CharacteristicTypesTest(unittest.TestCase):
    ...
    def test_get_uuid_short_uuid(self):
        self.assertEqual(
            "0000006D-0000-1000-8000-0026BB765291", CharacteristicsTypes.get_uuid("6D")
        )
    ...
    def test_get_short_uuid_full_uuid(self):
        self.assertEqual(
            "6D",
            CharacteristicsTypes.get_short_uuid("0000006D-0000-1000-8000-0026BB765291"),
        )
    ...
    def test_get_short_full_uuid(self):
        self.assertEqual(
            "position.current",
            CharacteristicsTypes.get_short("0000006D-0000-1000-8000-0026BB765291"),
        )
    ...
    def test_get_short_unknown(self):
        self.assertEqual(
            "Unknown Characteristic 1234", CharacteristicsTypes.get_short("1234")
        )

    def test_getitem_short_uuid(self):
        self.assertEqual(
            "public.hap.characteristic.position.current", CharacteristicsTypes["6D"]
        )

    def test_getitem_name(self):
        self.assertEqual(
            "6D", CharacteristicsTypes["public.hap.characteristic.position.current"]
        )
